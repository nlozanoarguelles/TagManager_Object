window.TagManager = function(settings) {
    ...
    /**
     * Funcion que permite la subscriptción de varios eventos bajo un mismo callback
    ...
    _self.log = function(dataToLog) {
        ...
        if (_self.getDebug()) {
            var tm_css = 'background: #556270; color: #4ECDC4';
            var tm_log = 'background: #556270; color: #C7F464';
            var data_css = 'color: #00ABD6';
            console.log('%c[TagManager]%c[log]%c %s', tm_css, tm_log, data_css, dataToLog);
        }
    };
    /**
     * Funcion utilizada para lanzar los mensajes de log asociados al objeto TagManager. Con cada llamada a log se hace una emisión de un evento "log" pasando como parametro el mensaje de log
     * @param  {whatever} dataToLog Debe tratarse esta función como si fuese un console.log interno 
     */
    _self.warn = function(dataToLog) {
        _self.emit('warn', dataToLog);
        if (_self.getDebug()) {
            var tm_css = 'background: #556270; color: #4ECDC4';
            var tm_log = 'background: #556270; color: #F9DB18';
            var data_css = 'color: #00ABD6';
            console.log('%c[TagManager]%c[warning]%c %s', tm_css, tm_log, data_css, dataToLog);
        }
    };
    ...
    _self.error = function(error, text) {
        ...
        if (_self.getDebug()) {
            var tm_css = 'display: block; background: #556270; color: #4ECDC4';
            var tm_log = 'background: #556270; color: #FF6B6B';
            console.log('%c[TagManager]%c[error]', tm_css, tm_log);
            console.error(text);
            console.error(error);
        }
    };
    ...
    /**
     * Cuando se rellena un data, lo aplana y lo introduce en el objeto de Google Tag Manager a la vez que genera su evento asociado
     */
    var gtmParser = function(dataLayerReference) {
        //Parsing events
        _self.onAny(function(event) {

            var eventName = Array.isArray(event) ? event.join('.') : event;
            if (typeof eventName != 'undefined' && dataLayerReference) {
                if (eventName.indexOf("dataFilled.") > -1 && eventName.indexOf(".priority-") == -1) {
                    ...
                    for (d in dataFlattened) {
                        ...
                        _self.log('[gtmParser]: added to the dataLayer: ' + fullName + "=" + dataFlattened[d]);
                        var objectToPush = {};
                        objectToPush[fullName] = dataFlattened[d];
                        dataLayerReference.push(objectToPush);
                    }
                }
...
! function(e) {
    function t() { this._events = {}, this._conf && s.call(this, this._conf) }

    function s(e) { e && (this._conf = e, e.delimiter && (this.delimiter = e.delimiter), e.maxListeners && (this._events.maxListeners = e.maxListeners), e.wildcard && (this.wildcard = e.wildcard), e.newListener && (this.newListener = e.newListener), this.wildcard && (this.listenerTree = {})) }

    function i(e) { this._events = {}, this.newListener = !1, s.call(this, e) }

    function n(e, t, s, i) { if (!s) return []; var r, l, a, h, o, c, f, u = [],
            p = t.length,
            _ = t[i],
            v = t[i + 1]; if (i === p && s._listeners) { if ("function" == typeof s._listeners) return e && e.push(s._listeners), [s]; for (r = 0, l = s._listeners.length; l > r; r++) e && e.push(s._listeners[r]); return [s] } if ("*" === _ || "**" === _ || s[_]) { if ("*" === _) { for (a in s) "_listeners" !== a && s.hasOwnProperty(a) && (u = u.concat(n(e, t, s[a], i + 1))); return u } if ("**" === _) { f = i + 1 === p || i + 2 === p && "*" === v, f && s._listeners && (u = u.concat(n(e, t, s, p))); for (a in s) "_listeners" !== a && s.hasOwnProperty(a) && ("*" === a || "**" === a ? (s[a]._listeners && !f && (u = u.concat(n(e, t, s[a], p))), u = u.concat(n(e, t, s[a], i))) : u = a === v ? u.concat(n(e, t, s[a], i + 2)) : u.concat(n(e, t, s[a], i))); return u } u = u.concat(n(e, t, s[_], i + 1)) } if (h = s["*"], h && n(e, t, h, i + 1), o = s["**"])
            if (p > i) { o._listeners && n(e, t, o, p); for (a in o) "_listeners" !== a && o.hasOwnProperty(a) && (a === v ? n(e, t, o[a], i + 2) : a === _ ? n(e, t, o[a], i + 1) : (c = {}, c[a] = o[a], n(e, t, { "**": c }, i + 1))) } else o._listeners ? n(e, t, o, p) : o["*"] && o["*"]._listeners && n(e, t, o["*"], p); return u }

    function r(e, t) { e = "string" == typeof e ? e.split(this.delimiter) : e.slice(); for (var s = 0, i = e.length; i > s + 1; s++)
            if ("**" === e[s] && "**" === e[s + 1]) return; for (var n = this.listenerTree, r = e.shift(); r;) { if (n[r] || (n[r] = {}), n = n[r], 0 === e.length) { if (n._listeners) { if ("function" == typeof n._listeners) n._listeners = [n._listeners, t];
                    else if (l(n._listeners) && (n._listeners.push(t), !n._listeners.warned)) { var h = a; "undefined" != typeof this._events.maxListeners && (h = this._events.maxListeners), h > 0 && n._listeners.length > h && (n._listeners.warned = !0, console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.", n._listeners.length), console.trace && console.trace()) } } else n._listeners = t; return !0 } r = e.shift() } return !0 } var l = Array.isArray ? Array.isArray : function(e) { return "[object Array]" === Object.prototype.toString.call(e) },
        a = 10;
    i.EventEmitter2 = i, i.prototype.delimiter = ".", i.prototype.setMaxListeners = function(e) { this._events || t.call(this), this._events.maxListeners = e, this._conf || (this._conf = {}), this._conf.maxListeners = e }, i.prototype.event = "", i.prototype.once = function(e, t) { return this.many(e, 1, t), this }, i.prototype.many = function(e, t, s) {
        function i() { 0 === --t && n.off(e, i), s.apply(this, arguments) } var n = this; if ("function" != typeof s) throw new Error("many only accepts instances of Function"); return i._origin = s, this.on(e, i), n }, i.prototype.emit = function() { this._events || t.call(this); var e = arguments[0]; if ("newListener" === e && !this.newListener && !this._events.newListener) return !1; var s, i, r, l, a, h = arguments.length; if (this._all && this._all.length) { if (a = this._all.slice(), h > 3)
                for (s = new Array(h), l = 1; h > l; l++) s[l] = arguments[l]; for (r = 0, i = a.length; i > r; r++) switch (this.event = e, h) {
                case 1:
                    a[r].call(this, e); break;
                case 2:
                    a[r].call(this, e, arguments[1]); break;
                case 3:
                    a[r].call(this, e, arguments[1], arguments[2]); break;
                default:
                    a[r].apply(this, s) } } if (this.wildcard) { a = []; var o = "string" == typeof e ? e.split(this.delimiter) : e.slice();
            n.call(this, a, o, this.listenerTree, 0) } else { if (a = this._events[e], "function" == typeof a) { switch (this.event = e, h) {
                    case 1:
                        a.call(this); break;
                    case 2:
                    ...
                    default:
                        for (s = new Array(h - 1), l = 1; h > l; l++) s[l - 1] = arguments[l];
                        a.apply(this, s) } return !0 } a && (a = a.slice()) } if (a && a.length) { if (h > 3)
                for (s = new Array(h - 1), l = 1; h > l; l++) s[l - 1] = arguments[l]; for (r = 0, i = a.length; i > r; r++) switch (this.event = e, h) {
                case 1:
                    a[r].call(this); break;
                case 2:
                    a[r].call(this, arguments[1]); break;
                case 3:
                    a[r].call(this, arguments[1], arguments[2]); break;
                default:
                    a[r].apply(this, s) }
            return !0 } if (!this._all && "error" === e) throw arguments[1] instanceof Error ? arguments[1] : new Error("Uncaught, unspecified 'error' event."); return !!this._all }, i.prototype.emitAsync = function() { this._events || t.call(this); var e = arguments[0]; if ("newListener" === e && !this.newListener && !this._events.newListener) return Promise.resolve([!1]); var s, i, r, l, a, h = [],
            o = arguments.length; if (this._all) { if (o > 3)
                for (s = new Array(o), l = 1; o > l; l++) s[l] = arguments[l]; for (r = 0, i = this._all.length; i > r; r++) switch (this.event = e, o) {
                case 1:
                    h.push(this._all[r].call(this, e)); break;
                case 2:
                    h.push(this._all[r].call(this, e, arguments[1])); break;
                case 3:
                    h.push(this._all[r].call(this, e, arguments[1], arguments[2])); break;
                default:
                    h.push(this._all[r].apply(this, s)) } } if (this.wildcard) { a = []; var c = "string" == typeof e ? e.split(this.delimiter) : e.slice();
            n.call(this, a, c, this.listenerTree, 0) } else a = this._events[e]; if ("function" == typeof a) switch (this.event = e, o) {
            case 1:
                h.push(a.call(this)); break;
            case 2:
                h.push(a.call(this, arguments[1])); break;
            case 3:
                h.push(a.call(this, arguments[1], arguments[2])); break;
            default:
                for (s = new Array(o - 1), l = 1; o > l; l++) s[l - 1] = arguments[l];
                h.push(a.apply(this, s)) } else if (a && a.length) { if (o > 3)
                for (s = new Array(o - 1), l = 1; o > l; l++) s[l - 1] = arguments[l]; for (r = 0, i = a.length; i > r; r++) switch (this.event = e, o) {
                case 1:
                    h.push(a[r].call(this)); break;
                case 2:
                    h.push(a[r].call(this, arguments[1])); break;
                case 3:
                    h.push(a[r].call(this, arguments[1], arguments[2])); break;
                default:
                    h.push(a[r].apply(this, s)) } } else if (!this._all && "error" === e) return arguments[1] instanceof Error ? Promise.reject(arguments[1]) : Promise.reject("Uncaught, unspecified 'error' event."); return Promise.all(h) }, i.prototype.on = function(e, s) { if ("function" == typeof e) return this.onAny(e), this; if ("function" != typeof s) throw new Error("on only accepts instances of Function"); if (this._events || t.call(this), this.emit("newListener", e, s), this.wildcard) return r.call(this, e, s), this; if (this._events[e]) { if ("function" == typeof this._events[e]) this._events[e] = [this._events[e], s];
            else if (l(this._events[e]) && (this._events[e].push(s), !this._events[e].warned)) { var i = a; "undefined" != typeof this._events.maxListeners && (i = this._events.maxListeners), i > 0 && this._events[e].length > i && (this._events[e].warned = !0, console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.", this._events[e].length), console.trace && console.trace()) } } else this._events[e] = s; return this }, i.prototype.onAny = function(e) { if ("function" != typeof e) throw new Error("onAny only accepts instances of Function"); return this._all || (this._all = []), this._all.push(e), this }, i.prototype.addListener = i.prototype.on, i.prototype.off = function(t, s) {
        function i(t) { if (t !== e) { var s = Object.keys(t); for (var n in s) { var r = s[n],
                        l = t[r];
                    l instanceof Function || "object" != typeof l || (Object.keys(l).length > 0 && i(t[r]), 0 === Object.keys(l).length && delete t[r]) } } } if ("function" != typeof s) throw new Error("removeListener only takes instances of Function"); var r, a = []; if (this.wildcard) { var h = "string" == typeof t ? t.split(this.delimiter) : t.slice();
            a = n.call(this, null, h, this.listenerTree, 0) } else { if (!this._events[t]) return this;
            r = this._events[t], a.push({ _listeners: r }) } for (var o = 0; o < a.length; o++) { var c = a[o]; if (r = c._listeners, l(r)) { for (var f = -1, u = 0, p = r.length; p > u; u++)
                    if (r[u] === s || r[u].listener && r[u].listener === s || r[u]._origin && r[u]._origin === s) { f = u; break } if (0 > f) continue; return this.wildcard ? c._listeners.splice(f, 1) : this._events[t].splice(f, 1), 0 === r.length && (this.wildcard ? delete c._listeners : delete this._events[t]), this.emit("removeListener", t, s), this }(r === s || r.listener && r.listener === s || r._origin && r._origin === s) && (this.wildcard ? delete c._listeners : delete this._events[t], this.emit("removeListener", t, s)) } return i(this.listenerTree), this }, i.prototype.offAny = function(e) { var t, s = 0,
            i = 0; if (e && this._all && this._all.length > 0) { for (t = this._all, s = 0, i = t.length; i > s; s++)
                if (e === t[s]) return t.splice(s, 1), this.emit("removeListenerAny", e), this } else { for (t = this._all, s = 0, i = t.length; i > s; s++) this.emit("removeListenerAny", t[s]);
            this._all = [] } return this }, i.prototype.removeListener = i.prototype.off, i.prototype.removeAllListeners = function(e) { if (0 === arguments.length) return !this._events || t.call(this), this; if (this.wildcard)
            for (var s = "string" == typeof e ? e.split(this.delimiter) : e.slice(), i = n.call(this, null, s, this.listenerTree, 0), r = 0; r < i.length; r++) { var l = i[r];
                l._listeners = null } else { if (!this._events || !this._events[e]) return this;
                this._events[e] = null }
        return this }, i.prototype.listeners = function(e) { if (this.wildcard) { var s = [],
                i = "string" == typeof e ? e.split(this.delimiter) : e.slice(); return n.call(this, s, i, this.listenerTree, 0), s } return this._events || t.call(this), this._events[e] || (this._events[e] = []), l(this._events[e]) || (this._events[e] = [this._events[e]]), this._events[e] }, i.prototype.listenersAny = function() { return this._all ? this._all : [] }, "function" == typeof define && define.amd ? define(function() { return i }) : "object" == typeof exports ? module.exports = i : window.EventEmitter2 = i }();
//TagManager Herencia
